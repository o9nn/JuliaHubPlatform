# Autogenerated wrapper script for GoogleCodeSearch_jll for x86_64-w64-mingw32
...
const csearch_splitpath = ["bin", "csearch.exe"]
...
const cindex_splitpath = ["bin", "cindex.exe"]
