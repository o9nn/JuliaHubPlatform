...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GoogleCodeSearch_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6c08f7c7-e449-597e-96d3-8117915de277"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GoogleCodeSearch", artifacts_toml) for e in artifacts["GoogleCodeSearch"]]
...
if best_platform === nothing
    @debug("Unable to load GoogleCodeSearch; unsupported platform $(triplet(platform_key_abi()))")
else
